...
const nuevaCompra = {
      ...
      try {
        ...
        await Collections.set('compras', nuevaCompra.id, nuevaCompra);
                          ...
                          <TableCell colSpan={9} className="px-8 py-4">
                            <div className="card border-line bg-white shadow-inner rounded-xl overflow-hidden">
                              <table className="w-full">
                                ...
                                <tbody>
                                  {c.items.map((it: { nombre: string; cantidad: number; costoUnitarioUSD: number; subtotalUSD: number }, idx: number) => (
        ...
        <ProductFormModal 
          ...
          onSave={(datos) => {
            ...
            if (nuevo.stock > 0) {
              ...
              // 🔑 Persistir producto + movimiento inicial
              Collections.set('productos', nuevo.id, nuevo);
              Collections.set('movimientos', mov.id, mov);
